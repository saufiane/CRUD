...
<head>
    ...
    <title>Maniamicro | Détails du produit</title>
    ...
    <main class="container">
        <div class="row">
            <section class="col-12">
                ...
                <p>Lieu : <?= $produit['lieu'] ?></p>
                <p>Nombre : <?= $produit['nombre'] ?></p>
                <p>Reference : <?= $produit['reference'] ?></p>
                <p>Categorie : <?= $produit['categorie'] ?></p>
                <p>Date d'achat : <?= $produit['dates'] ?></p>
                <p>Garantie : <?= $produit['garantie'] ?></p>
                <p>Conseils d'entretien : <?= $produit['entretien'] ?></p>
                <p>Photo du produit :<img src="images/<?= $produit['ticket_photo']?>"alt=""></p>
